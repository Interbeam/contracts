import { ChainId, parseTokenBridgeRegisterChainVaa, SignedVaa, tryNativeToUint8Array } from '@certusone/wormhole-sdk'
...
export function createMaliciousRegisterChainInstruction(
  ...
  return methods._ixFn(...methods._args, {
    accounts: getRegisterChainAccounts(tokenBridgeProgramId, wormholeProgramId, payer, vaa) as any,
    signers: undefined,
