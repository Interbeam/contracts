...
use crate::PostedInterbeamMessage;
...
impl ForeignContract {
    ...
    /// this account.
    pub fn verify(&self, vaa: &PostedInterbeamMessage) -> bool {
...
//         let vaa = PostedInterbeamMessage {
